...
map.getView().fit([-7980141.822726, 5171773.389873, -7875156.412185, 5270383.393607], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ADU MA Turf Map</h2>';
        return titleElement;
    })(),
